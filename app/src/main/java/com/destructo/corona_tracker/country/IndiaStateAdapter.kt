...
import com.destructo.corona_tracker.databinding.StateDataListItemBinding
...
class IndiaStateAdapter(private val clickListener: StateClickListener): ListAdapter<IndiaStateStats,
    ...
    class ViewHolder(val binding: StateDataListItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = StateDataListItemBinding.inflate(layoutInflater, parent, false)
                return ViewHolder(
                    binding
                )
            }
